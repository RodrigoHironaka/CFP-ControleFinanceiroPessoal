...
create table FluxoCaixas (Id BIGINT not null, Nome VARCHAR(150), DataGeracao DATETIME, DataAlteracao DATETIME, Caixa BIGINT, primary key (Id)) ENGINE=InnoDB;
...
create table Caixas (ID BIGINT not null, Codigo BIGINT, DataAbertura DATETIME, DataFechamento DATETIME, TotalEntrada DECIMAL(19,5), TotalSaida DECIMAL(19,5), BalançoFinal DECIMAL(19,5), Situacao INTEGER, Pessoa BIGINT, Conta BIGINT, primary key (ID)) ENGINE=InnoDB;
